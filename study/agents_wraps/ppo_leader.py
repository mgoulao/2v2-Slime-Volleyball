...
class PPO_LEADER:
    def __init__(self, state_dim, action_space, lr_actor, lr_critic, gamma, K_epochs, eps_clip, has_continuous_action_space, action_std_init=0.6):
        ...
        self.action_dim = self.action_space**2  # we want all the possible combinations of actions
        if has_continuous_action_space:
...
class PPO_SLAVE:
    def __init__(self, state_dim, action_space, lr_actor, lr_critic, gamma, K_epochs, eps_clip, has_continuous_action_space, action_std_init=0.6):
        ...
        self.action_space = action_space
        self.action_dim = action_space  # we want all the possible combinations of actions
        if has_continuous_action_space:
            self.action_std = action_std_init
...
class LEADER_TEAM(BaseTeam):
    ...
    def __init__(self, env, logdir="./leader_saves"):
        ...
        lr_actor = 0.0003
        lr_critic = 0.001 
        self.agent1 = PPO_LEADER(self.state_dim, self.action_space, lr_actor, lr_critic, gamma, K_epochs, eps_clip, False)
        self.agent2 = PPO_SLAVE(self.state_dim, self.action_space, lr_actor, lr_critic, gamma, K_epochs, eps_clip, False)
        self.writer = SummaryWriter('logs/leader_1')
